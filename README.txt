...
ogre-weights.dmat	.dmat "dense matrix" containing the weights matrix W, which is #mesh vertices by 
			#skeletal bones
...
Example: ./main ogre.obj ogre-skeleton.bf ogre-weights.dmat pose.dmat output-%05d.obj
	...
	"ogre.obj", "ogre-skeleton.bf", "ogre-weights.dmat" and "pose.dmat" are the files that we need to 
	input
	"output-%05d.pose" is the format that we output the files. For this project, you'll have two output 
	files.
